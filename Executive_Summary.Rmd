...
accidents<-read.csv('https://github.com/daiyang94815/Project/raw/master/data/dftRoadSafety_Accidents_2016.csv',stringsAsFactors = F)
vehicle<-read.csv('https://github.com/daiyang94815/Project/raw/master/data/Veh.csv',stringsAsFactors = F)
